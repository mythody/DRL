...
class KukaDiverseObjectEnv(KukaGymEnv):
  ...
  def __init__(self,
    ...
    self._isTest = isTest
    self._cameraArm = cameraArm
    self._init_camera_vector = (0, 0, 1) # z-axis
    self._init_up_vector = (-1, 0, 0) # x-axis
  ...
  def reset(self):
    ...
    fov = self._initial_fov + self._cameraRandom * np.random.uniform(-2, 2)
  ...
  def _updateCameraPos(self):
      ...
      init_camera_vector = self._init_camera_vector # z-axis
      init_up_vector = self._init_up_vector # y-axis
      # Rotated vectors
      camera_vector = rot_matrix.dot(init_camera_vector)
      up_vector = rot_matrix.dot(init_up_vector)
      camera_eye_pos = com_p
      camera_target_pos = com_p + 0.1 * camera_vector
      self._view_matrix = p.computeViewMatrix(camera_eye_pos, camera_target_pos, up_vector)
  ...
  def _get_observation(self, obs_type='RGB'):
    ...
    #if self._cameraArm:
    if(self._cam_view_option == 1):
        self._updateCameraPos()
    elif(self._cam_view_option == 2):
        self._updateCameraPos_2()
